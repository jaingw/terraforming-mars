...
export class Engineer implements IAward {
  ...
  public getScore(player: Player): number {
    ...
    if (player.corpCard !== undefined && Engineer.productionCards.includes(player.corpCard.name)) score += 1;
    if (player.corpCard2 !== undefined && Engineer.productionCards.includes(player.corpCard2.name)) score += 1;
