...
export const MOON_CARD_MANIFEST = new CardManifest({
  ...
  corporationCards: [
    ...
    {cardName: CardName.LUNA_FIRST_INCORPORATED, Factory: LunaFirstIncorporated, compatibility: 'moon'},
    {cardName: CardName.THE_GRAND_LUNA_CAPITAL_GROUP, Factory: TheGrandLunaCapitalGroup, compatibility: 'moon'},
    {cardName: CardName.INTRAGEN_SANCTUARY_HEADQUARTERS, Factory: IntragenSanctuaryHeadquarters, compatibility: 'moon'},
    // {cardName: CardName.LUNA_TRADE_FEDERATION, Factory: LunaTradeFederation},
    {cardName: CardName.THE_ARCHAIC_FOUNDATION_INSTITUTE, Factory: TheArchaicFoundationInstitute, compatibility: 'moon'},
  ],
  standardProjects: [
