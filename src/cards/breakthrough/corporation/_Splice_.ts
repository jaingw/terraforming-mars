...
export class _Splice_ extends Splice {
  ...
  public get metadata() {
    return {
      cardNumber: 'R28',
      description: 'You start with 44 MC. As your first action, reveal cards until you have revealed 2 microbe tag. Take these cards into hand and discard the rest.',
