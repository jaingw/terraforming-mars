...
export const CardCorporationLogo = Vue.component('CardCorporationLogo', {
  ...
  methods: {
    getHtmlContent: function(): string {
      ...
      case CardName._MORNING_STAR_INC_:
      ...
      case CardName._ARCADIAN_COMMUNITIES_:
      ...
      case CardName._MINING_GUILD_:
        return '<span class="card-mining-guild-breakthrough-logo">MINING<br>GUILD</span>';
      ...
      case CardName._UNITED_NATIONS_MARS_INITIATIVE_:
