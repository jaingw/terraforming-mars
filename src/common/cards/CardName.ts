export enum CardName {
  ...
  CASINOS = 'Casinos',
    ...
    WEYLAND_YUTANI = '🌸韦兰德-尤坦尼集团🌸',
    SHINRA_TECH = '🌸樱花电🌸',
    TYRELL = '🌸泰瑞尔公司🌸',
    MINING_CORP = '🌸钢铁精炼🌸',
    SCOLEX_INDUSTRIES = '🌸星核工业🌸',
    PROTOGEN = '🌸微生物热舞🌸',
    INTEGRATED_MICROORGANISMS = '🌸微生物星尘🌸',
    BUY_N_LARGE = '🌸大巨购🌸',
    RDA = '🌸RDA🌸',
    ARK_NOVA = '🌸方舟动物园🌸',
    ...
    ELITETECH = '🌸精英回馈🌸',
    SOLARPLANT = '🌸太阳能公司🌸',
    POLITICALREFORM = '🌸制度改革🌸',
    STARLINKDRIFTER = '🌸星链漂流者🌸',
    PROWLER = '🌸徘徊者🌸',
    MIRRORCOAT = '🌸镜反🌸',
    GREENRING = '🌸绿环🌸',
    ENERGY_SAVING_ECOLOGY = '🌸节能生态🌸',
    GREEN_LEAF_DANCE = '🌸绿叶舞动🌸',
