        ...
        <div style="font-family: 'Microsoft YaHei'">
            ...
            <div class="donate-screen">
                ...
                <div class="donate-screen-links" title="充钱你会变得更强" style="font-family: 'SF Mono','Segoe UI Mono','Roboto Mono';">
                    全新土豆功能上线。以下功能为土豆<img src="assets/qrcode/potato.png" style="height: 30px;vertical-align: middle;" />用户尊享：<br>
                    1、 对局回合外回退，每天5次<br>
                    ...
                    由于火星服务器费用日渐增长，土豆用户需赞助获得，赞助所得用来服务器日常运营，支付时请务必备注本站注册用户名,否则土豆不能到账。<br>
                    !!!只需要赞助火星开发30R,就可以收获半年土豆!!!<br>
                    <br>
                </div>
                <div  title="充钱你会变得更强">
                    <img src="assets/qrcode/donatewx.jpg " style="" />
                    <img src="assets/qrcode/donatezfb.jpg " style="" />
                </div>
                <div  title="充钱你会变得更强">
                    扫描下方二维码添加微信进微信群 或者 进qq群约局
